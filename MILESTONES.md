...
- Latest app optimization commit: `0b78ee2 db: raise mysqld max_connections 151 -> 1024` (on top of `00b7246`, the batch-matching redesign; `maxMatchesPerCall = 10`).
- Latest verified benchmark: `pass=true`, score `22818`, errors `map[]` (zero errors).
- Latest iteration report: `reports/iterations/iteration-20260923-173600.md`.
